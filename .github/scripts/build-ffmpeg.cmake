...
if(NOT EMSCRIPTEN AND NOT IOS_IPADOS AND FFMPEG)
	...
	elseif(WIN32)
		...
		elseif(TARGET_ARCH STREQUAL "arm64")
			# ffmpeg requests the GNU assembler even when building with MSVC.
			# That sounds to me like it wouldn't work, so I'm just disabling it
			# for now instead of sinking time into getting that thing installed.
			list(PREPEND ffmpeg_configure_args --arch=arm64 --disable-asm)
		else()
			message(FATAL_ERROR "Unhandled TARGET_ARCH '${TARGET_ARCH}'")
		endif()
