...
function(build_dependency name version build_type)
	...
	elseif(generator STREQUAL "automake")
		_build_automake("${build_type}" "${BUILD_TARGET_BITS}" "${source_build_dir}" ${BUILD_ARGS})
	elseif(generator STREQUAL "cmake")
		_build_cmake("${build_type}" "${BUILD_TARGET_BITS}" "${source_build_dir}" ${BUILD_ARGS})
	elseif(WIN32 AND generator STREQUAL "msbuild")
		_build_msbuild("${build_type}" "${BUILD_TARGET_BITS}" "${source_build_dir}" ${BUILD_ARGS})
	else()
