 ...
 */
#ifndef DPMSG_FEATURE_LEVELS_H
#define DPMSG_FEATURE_LEVELS_H
#include <dpcommon/common.h>

typedef struct DP_Message DP_Message;


#define DP_MSG_FEATURE_LEVELS_FEATURE_COUNT 9

typedef struct DP_MsgFeatureLevels DP_MsgFeatureLevels;
