...
{
    return DP_zero_length_new(DP_MSG_UNDO_POINT, context_id);
}
...
DP_Message *DP_msg_undo_point_deserialize(unsigned int context_id,
                                          ...
                                          size_t length)
{
    return DP_zero_length_deserialize(DP_MSG_UNDO_POINT, context_id, buffer,
                                      length);
}
...
{
    return DP_message_cast(msg, DP_MSG_UNDO_POINT);
}
