...
elseif(IMAGE_IMPL STREQUAL "QT")
    dp_find_package("Qt${QT_VERSION}" COMPONENTS Gui REQUIRED)
endif()
...
if(NOT EMSCRIPTEN)
    dp_find_package("Qt${QT_VERSION}" COMPONENTS Xml REQUIRED)
...
if(USE_GENERATORS)
    dp_find_package("Qt${QT_VERSION}" COMPONENTS Core Gui)
endif()
