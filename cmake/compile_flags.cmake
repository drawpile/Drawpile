...
if(MSVC)
    ...
    #  - MSVC has no `__attribute__((unused))` and parameter names are not
    #    omitted from the code
    # C4200: nonstandard extension used: zero-sized array in struct/union
    #  - MSVC does not recognise C99 flexible array members as standard
    # C4127: conditional expression is constant
    #  - macros from cthash emit `do {} while(0);` and this triggers on
    #    `while(0)`
    # C4702: unreachable code
    #  - macros from cthash causing problems again
    add_compile_options(/utf-8 /W4 /wd4100 /wd4200 /wd4127 /wd4702)
    if(ENABLE_WERROR)
