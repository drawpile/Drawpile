...
#define DP_MSG_CAMERA_ATTRIBUTES_STATIC_LENGTH        32
#define DP_MSG_CAMERA_ATTRIBUTES_STATIC_LENGTH_COMPAT 32
...
DP_Message *DP_msg_camera_attributes_new(
    ...
    int32_t fpms, uint16_t range_first, uint16_t range_last,
    uint16_t output_width, uint16_t output_height, int32_t viewport_left,
    int32_t viewport_top, int32_t viewport_right, int32_t viewport_bottom);
...
int32_t DP_msg_camera_attributes_fpms(const DP_MsgCameraAttributes *mca);
