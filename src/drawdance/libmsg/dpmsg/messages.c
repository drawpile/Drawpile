...
static const DP_MessageMethods msg_default_layer_methods = {
    msg_default_layer_payload_length,     msg_default_layer_serialize_payload,
    msg_default_layer_payload_length,     msg_default_layer_serialize_payload,
    msg_default_layer_write_payload_text, msg_default_layer_equals,
};
...
{
    DP_Message *msg =
        DP_msg_default_layer_deserialize(context_id, buffer, length);
    DP_message_compat_set(msg);
    return msg;
}
                                                         ...
                                                         unsigned char *data)
{
    ...
    written += DP_write_bigendian_uint16(mkfs->frame_index, data + written);
    written += mkfs->source == DP_MSG_KEY_FRAME_SET_SOURCE_LAYER
                 ? serialize_layer_id_compat(mkfs->source_id)
                 : DP_uint32_to_uint16(mkfs->source_id);
    written += DP_write_bigendian_uint16(mkfs->source_index, data + written);
    written += DP_write_bigendian_uint8(mkfs->source, data + written);
