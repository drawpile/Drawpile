                                                      ...
                                                      unsigned char *data)
{
    ...
    written += DP_write_bigendian_int32(mca->fpms, data + written);
                                                     ...
                                                     DP_TextWriter *writer)
{
    ...
    return DP_text_writer_write_uint(writer, "flags", mca->flags)
        && DP_text_writer_write_int(writer, "fpms", mca->fpms)
                                         ...
                                         DP_Message *DP_RESTRICT other)
{
    ...
    return a->id == b->id && a->flags == b->flags
        && a->interpolation == b->interpolation && a->fpms == b->fpms
                                                 ...
                                                 size_t length)
{
    ...
    int32_t fpms = read_int32(buffer + read, &read);
    ...
    return DP_msg_camera_attributes_new(
        context_id, id, flags, interpolation, fpms, range_first, range_last,
        output_width, output_height, viewport_left, viewport_top,
                                           ...
                                           DP_TextReader *reader)
{
    ...
    int32_t fpms =
        (int32_t)DP_text_reader_get_long(reader, "fpms", INT32_MIN, INT32_MAX);
    uint16_t range_first =
