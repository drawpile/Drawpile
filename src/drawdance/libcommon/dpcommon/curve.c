...
typedef int (*DP_CurveGetCountFn)(DP_Curve *curve);
typedef const DP_Vec2 *(*DP_CurveGetPointsFn)(DP_Curve *curve);
typedef double (*DP_CurveGetValueAtFn)(DP_Curve *curve, double x);
...
static int null_curve_get_count(DP_UNUSED DP_Curve *curve)
{
    return 0;
}

static const DP_Vec2 *null_curve_get_points(DP_UNUSED DP_Curve *curve)
{
    return NULL;
}

static double null_curve_get_value_at(DP_UNUSED DP_Curve *curve, double x)
{
    return x;
}
...
static int mono_curve_get_count(DP_UNUSED DP_Curve *curve)
{
    return 1;
}

static const DP_Vec2 *mono_curve_get_points(DP_Curve *curve)
{
    DP_MonoCurve *mc = (DP_MonoCurve *)curve;
    return &mc->point;
}

static double mono_curve_get_value_at(DP_Curve *curve, DP_UNUSED double x)
{
    DP_MonoCurve *mc = (DP_MonoCurve *)curve;
    return mc->point.y;
}
...
static int duo_curve_get_count(DP_UNUSED DP_Curve *curve)
{
    return 2;
}

static const DP_Vec2 *duo_curve_get_points(DP_Curve *curve)
{
    DP_DuoCurve *dc = (DP_DuoCurve *)curve;
    return dc->points;
}

static double duo_curve_get_value_at(DP_Curve *curve, double x)
{
    DP_DuoCurve *dc = (DP_DuoCurve *)curve;
...
static int linear_curve_get_count(DP_Curve *curve)
{
    DP_LinearCurve *lc = (DP_LinearCurve *)curve;
    return lc->count;
}

static const DP_Vec2 *linear_curve_get_points(DP_Curve *curve)
{
    DP_LinearCurve *lc = (DP_LinearCurve *)curve;
    return lc->points;
}

static double linear_curve_get_value_at(DP_Curve *curve, double x)
{
    DP_LinearCurve *lc = (DP_LinearCurve *)curve;
    int last = lc->count - 1;
    double y;
...
static int cubic_curve_get_count(DP_Curve *curve)
{
    DP_CubicCurve *cc = (DP_CubicCurve *)curve;
    return cc->count;
}

static const DP_Vec2 *cubic_curve_get_points(DP_Curve *curve)
{
    DP_CubicCurve *cc = (DP_CubicCurve *)curve;
    return cubic_curve_points(cc);
}

static double cubic_curve_get_value_at(DP_Curve *curve, double x)
{
    DP_CubicCurve *cc = (DP_CubicCurve *)curve;
...
static double cubic_curve_get_value_at_invalid(DP_UNUSED DP_Curve *curve,
                                               DP_UNUSED double x)
{
