                                              ...
                                              DP_LayerContent *flood_lc_or_null)
{
    ...
    if (scaled_hardness == 100 || diameter < 48) {
        ...
        if (needs_mask_lc(top, left, diameter, flood_lc_or_null)) {
            apply_mask_lc(top, left, diameter, offset_mask, flood_lc_or_null);
        }
    ...
    else if (needs_mask_lc(top, left, diameter, flood_lc_or_null)) {
        apply_mask_lc_into(top, left, diameter, mask, offset_mask,
                           flood_lc_or_null);
        return (DP_BrushStamp){top, left, diameter, offset_mask};
    }
                ...
                if (needs_mask_lc(stamp.top, stamp.left, stamp.diameter,
                    ...
                    if (needs_mask_lc(stamp.top, stamp.left, stamp.diameter,
                        ...
                        apply_mask_lc(stamp.top, stamp.left, stamp.diameter,
                                      masked_buffer, flood_lc_or_null);
                    }
                                  ...
                                  DP_LayerContent *flood_lc_or_null)
{
    ...
    if (needs_mask_lc(top, left, diameter, mask_lc_or_null)) {
        ...
        if (needs_mask_lc(top, left, diameter, flood_lc_or_null)) {
            apply_mask_lc(top, left, diameter, dst, flood_lc_or_null);
        }
        stamp->data = dst;
    }
    else if (needs_mask_lc(top, left, diameter, flood_lc_or_null)) {
        apply_mask_lc_into(top, left, diameter, src, dst, flood_lc_or_null);
        stamp->data = dst;
    }
}
