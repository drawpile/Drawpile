...
#define DP_PROJECT_SESSION_OPEN_ERROR_ALREADY_OPEN (-301)
#define DP_PROJECT_SESSION_OPEN_ERROR_PREPARE      (-302)
#define DP_PROJECT_SESSION_OPEN_ERROR_WRITE        (-303)

#define DP_PROJECT_SESSION_CLOSE_ERROR_UNKNOWN   (-400)
#define DP_PROJECT_SESSION_CLOSE_ERROR_PREPARE   (-401)
#define DP_PROJECT_SESSION_CLOSE_ERROR_WRITE     (-402)
#define DP_PROJECT_SESSION_CLOSE_ERROR_NO_CHANGE (-403)
#define DP_PROJECT_SESSION_CLOSE_NOT_OPEN        1

#define DP_PROJECT_MESSAGE_RECORD_ERROR_UNKNOWN    (-500)
#define DP_PROJECT_MESSAGE_RECORD_ERROR_NO_SESSION (-501)
#define DP_PROJECT_MESSAGE_RECORD_ERROR_SERIALIZE  (-502)
#define DP_PROJECT_MESSAGE_RECORD_ERROR_WRITE      (-503)
